...
public class basic_ranged_enemy_ai : MonoBehaviour
{
    ...
    private void AttackPlayer(){
        ...
        if(canAttack){
            ...
            GameObject chiliBullet = Instantiate(bulletPrefab, new Vector3(0,0,0), Quaternion.identity);
            
            EnemyProjectile projectile = chiliBullet.GetComponent<EnemyProjectile>();
